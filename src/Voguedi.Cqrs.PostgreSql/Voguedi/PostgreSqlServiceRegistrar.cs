...
namespace Voguedi
{
    class PostgreSqlServiceRegistrar : IServiceRegistrar
    {
        ...
        public void Register(IServiceCollection services)
        {
            ...
            services.TryAddEnumerable(ServiceDescriptor.Singleton<IStore, PostgreSqlEventStore>());
            services.TryAddEnumerable(ServiceDescriptor.Singleton<IStore, PostgreSqlEventVersionStore>());
        }
